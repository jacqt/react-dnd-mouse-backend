...
var MouseBackend = function () {
  ...
  _createClass(MouseBackend, [{
    ...
    key: 'somewhatDifferent',
    value: function somewhatDifferent(offset1, offset2) {
      var dist = Math.pow(offset1.x - offset2.x, 2) + Math.pow(offset1.y - offset2.y, 2);
      return dist > 4;
    }
  }, {
    ...
    value: function handleWindowMoveCapture(e) {
      ...
      if (!this.monitor.isDragging() && this.mouseClientOffset.hasOwnProperty('x') && moveStartSourceIds && this.somewhatDifferent(this.mouseClientOffset, clientOffset)) {
